...
public interface OrderRepository extends JpaRepository<OrderEntity, Integer> {
    ...
    @Query(value = "select o from OrderEntity o left join fetch o.trades where o.orderStatus = 0 and o.type = 0 and o.price >= ?1 order by o.price desc")
    List<OrderEntity> findSuitableBuyOrders(double price);

    @Query(value = "select o from OrderEntity o left join fetch o.trades where o.orderStatus = 0 and o.type = 1 and o.price <= ?1 order by o.price")
